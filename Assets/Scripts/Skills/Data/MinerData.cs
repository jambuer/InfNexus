...
/// <summary>
/// 'Miner' (Madencilik) becerisine özel bonus mantığını tanımlar.
/// LifeSkillData'dan miras alır.
/// </summary>
[CreateAssetMenu(fileName = "MinerData", menuName = "Skills/Life Skill Data/Miner Skill")]
public class MinerData : LifeSkillData
{
    [Header("Miner Bonusları")]
    [Tooltip("Seviye başına üretim (kazma) hızı bonusu (Örn: 0.01 = %1)")]
