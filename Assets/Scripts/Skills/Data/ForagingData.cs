...
/// <summary>
/// 'Foraging' (Toplayıcılık) becerisine özel bonus mantığını tanımlar.
/// LifeSkillData'dan miras alır.
/// </summary>
[CreateAssetMenu(fileName = "ForagingData", menuName = "Skills/Life Skill Data/Foraging Skill")]
public class ForagingData : LifeSkillData
{
    [Header("Foraging Bonusları")]
